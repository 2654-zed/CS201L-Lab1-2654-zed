...
public class Main {
    public static void main(String[] args) {
        ...
        if (choice == 'e') {
            ...
            x1 = input.nextInt();
            y1 = input.nextInt();
    // add code to get the other 2 values from the user
            x2 = input.nextInt();
            y2 = input.nextInt();
    ...
    // add code to check if the other 2 values are valid
            if (!((x2 >= -10 && x2 <= 10) &&
                (y2 >= -10 && y2 <= 10))){
                System.out.println("A value entered was not valid"); 
                return;                      
        ...
        // add code to generate the other 2 values
